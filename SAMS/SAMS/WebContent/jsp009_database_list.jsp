...
<body>
	...
	<a class="button2" href="jsp009_database_insert.html">student add</a>
...
align="center" display: none;">
	...
	<td align="center"><a href="student?action=readerModifyQuery&s_id=<%=s_id%>">修改</a></td>
    <td align="center"><a href="student?action=readerDel&s_id=<%=s_id%>">删除</a></td>
		</tr>
		<%		
			i++;
			}
